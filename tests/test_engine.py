...
class TestEngineApproval:
    def test_require_approval_external_email(self, policy_with_profiles: PolicyConfig) -> None:
        engine = Engine(policy_with_profiles)
        decision = engine.evaluate(
            GuardEvent(
                scope="action",
    ...
    def test_no_approval_internal_email(self, policy_with_profiles: PolicyConfig) -> None:
        engine = Engine(policy_with_profiles)
        decision = engine.evaluate(
            GuardEvent(
                scope="action",
